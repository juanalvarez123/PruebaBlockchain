...
import com.prueba.blockchain.pruebablockchain.consumers.validator.ValidatorConsumer;
...
public class BlockchainController {
  ...
  private final ValidatorConsumer validatorConsumer;

  public BlockchainController(ValidatorConsumer validatorConsumer) {
    this.validatorConsumer = validatorConsumer;
  }

  @PostMapping
  public ResponseEntity createTransaction() throws NoSuchAlgorithmException {
    ...
    validatorConsumer.postTransaction(batchListBytes);
